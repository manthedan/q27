# The q27 notebook (formerly README.md)

> This is the project scratch pad — upstream's working notes plus fork
> additions, preserved verbatim when the README was rewritten (2026-07-16).
> It is a lab journal, not documentation: sections carry the date they
> were written and are NOT maintained. Current state lives in
> [README.md](../README.md) and [METAL_PROGRESS.md](METAL_PROGRESS.md).
